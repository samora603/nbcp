...
| [wp-01-outbox-implementation-package.md](wp-01-outbox-implementation-package.md) | Pre-code package for Outbox Foundation (M1) |
| [architecture-automation-backlog.md](architecture-automation-backlog.md) | ADR-0006 capabilities to automate (tool-agnostic) |

**Readiness:** [architecture-readiness-reassessment.md](../reviews/architecture-readiness-reassessment.md)
